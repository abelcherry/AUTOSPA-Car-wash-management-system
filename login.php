...
if (isset($_SESSION["username"])) {
    ...
    // If logged in, redirect to the home page or any other authenticated page
    header("Location: car2.html");
    exit();
}
...
<header>
        <div class="logo">
            <img  src="logo1.png" style="height: 35px; width: auto;" alt="Logo">
     </div>
    ...
    <div class="banner">
        <img src="banner4.jpg" alt="Banner Image">
    </div> 
    <!-- Login Section -->
